...
export const CLIENT_DATA = {
    NAME: "Kampai",
    COUNTRY: "Suisse",
    STREET: "25 rue de Monthoux",
    CITY: "Genève",
    CAP: "1201",
    PHONE: "+41 22 900 18 96",
    EMAIL: "contact@kampai.ch",
...
export const TEXT_HISTOIRE_FAMILLE = "Le KAMPAI, c’est une histoire de famille. " +
    ...
    "matière de restauration à Genève. " +
    "Sa sœur, Cecilia Zapata, cheffe renommée du restaurant le Pachacamac gratifié de 14/20 au Gault&Millau 2018, " +
    "signe les bouchées généreuses et irrésistibles qui y sont servies en s’inspirant de l’influence japonaise sur la " +
    "cuisine péruvienne."

export const TEXT_HISTOIRE_GOUT = "Le Pérou est un melting-pot gastronomique dont l’histoire remonte au milieu " +
    "du 19e siècle avec l’arrivée successive d’immigrants d’Europe, " +
    "d’Asie et d’autres contrées d’Amérique latine. La cuisine nikkei (nom donné aux premiers Japonais établis au Pérou) " +
    "trouve son origine dans l’arrivée du premier flot de migrants nippons en 1899. En 1920, le Pérou comptait déjà 180’000 " +
    "Japonais au sein de sa population. Leurs ingrédients fétiches tels que le miso, le wasabi, le shoyu, le sésame, la " +
